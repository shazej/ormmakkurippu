...
async function runTests() {
    ...
    try {
        ...
        console.log(`Health Check: ${healthRes.status} ${healthRes.status === 200 ? '✅' : '❌'}`);
    } catch (e) {
    ...
    console.log(`Auth Gating (No Token): ${unauthorizedRes.status} ${unauthorizedRes.status === 401 ? '✅' : '❌'}`);
    ...
    console.log('🔑 Obtained valid Firebase ID Token (Mock)');
    ...
    console.log(`Delete Task: ${deleteRes.status} ${deleteRes.status === 200 ? '✅' : '❌'}`);
